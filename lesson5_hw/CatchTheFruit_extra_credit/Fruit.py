...
class Fruit():
    ...
    def __init__(self, window, windowWidth, windowHeight, fruitType, points=15):
        ...
        # It initializes the count of the fruits that were caught
        self.caughtCount = 0
    ...
    def incrementCount(self):
        # Increment the caught count for a fruit
        self.caughtCount += 1

    def getCaughtCount(self):
        # Return the caught count of a fruit
        return self.caughtCount
